...
export class AchievementsFormComponent implements OnInit {
  ...
  add(): void {
    ...
    this.cvService.createAchievement(sendData, this.resumeId).subscribe(
      data => {
        console.log(data);
  ...
  remove(i): void {
    ...
    this.cvService.removeAchievement(this.resumeId, id).subscribe(
      data => {
        console.log(data);
  ...
  edit(i): void {
    ...
    //this.languageEditForm = this.fb.group(mylanguage);
    //Object.assign(new FormGroup({}),mylanguage);
  ...
  save(): void {
    ...
    // const mylanguage=<FormGroup>mycontrol.at(this.activeEntry);
    // mylanguage.setValue({name:mylanguage.get('name').value,
    //   type:this.languageEditForm.get('type').value,
    //   listening:this.languageEditForm.get('listening').value,
    //   reading:this.languageEditForm.get('reading').value,
    //   speaking:this.languageEditForm.get('speaking').value,
    //   writing:this.languageEditForm.get('writing').value})
  ...
  getItems() {
    this.cvService.getAchievements(this.resumeId).subscribe(
      data => {
